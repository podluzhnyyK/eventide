...
var htmlmin = require('gulp-htmlmin'); //минификатоор html
...
gulp.task('gulp-concat-css', function () { //конкатинация css
    return gulp.src('app/lids-css/*.css')
        .pipe(concatCss('lids.css'))
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts', 'gulp-concat-css', 'build'], function () {
